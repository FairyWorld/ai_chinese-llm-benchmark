...
- 目前已囊括346个大模型，覆盖chatgpt、gpt-5.2、o4-mini、谷歌gemini-3-pro、Claude-4.6、文心ERNIE-X1.1、ERNIE-5.0、qwen3-max、qwen3-plus、百川、讯飞星火、商汤senseChat等商用模型，
...
# 最近评测更新
- [2026/2/9] v5.8.13版本
  - 新增大模型：claude-opus-4.6、GLM-5、MiniMax-M2.5
- [2026/2/2] v5.8.12版本
